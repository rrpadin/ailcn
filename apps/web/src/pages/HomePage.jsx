            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div className="text-center">
                    <div className="text-4xl font-bold text-gold mb-2" style={{ fontVariantNumeric: 'tabular-nums' }}>26</div>
                    <p className="text-sm text-muted-foreground">Certified consultants in network</p>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-gold mb-2" style={{ fontVariantNumeric: 'tabular-nums' }}>$1.4M</div>
