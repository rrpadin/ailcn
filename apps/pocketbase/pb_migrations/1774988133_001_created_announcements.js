...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_4710585487",
    "indexes": [],
    "listRule": "is_published = true || @request.auth.collectionName = \"admins\"",
    "name": "announcements",
    "system": false,
    "type": "base",
    "updateRule": "@request.auth.collectionName = \"admins\"",
    "viewRule": "is_published = true || @request.auth.collectionName = \"admins\""
  });
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_4710585487");
