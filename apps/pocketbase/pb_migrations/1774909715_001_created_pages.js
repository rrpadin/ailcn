...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "viewRule": "is_visible = true || @request.auth.collectionName = \"admins\""
  });
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_6594978155");
